...
export function addVisualStory(scenes: Scene[], cue: Cue) {
  ...
  assignVisual("beat-04", {
    ...
    notes: [
      { text: "Time taken from migration", at: cue("beat-04", "Time") },
      {
        text: "More preparation. Less migration work.",
        at: cue("beat-04", "became"),
      },
    ],
  });
  ...
  assignVisual("beat-05", {
    ...
    title: "A problem still needs solving",
    stages: [
    ...
    notes: [
      { text: "The technical problem is still here", at: 30 },
      { text: "Discussing how to discuss it", at: cue("beat-05", "tangled") },
      {
        text: "Migration waits behind the meeting system",
        at: cue("beat-05", "waited"),
      },
    ],
  });
  ...
  assignVisual("beat-06", {
    ...
    title: "The cost reaches delivery",
    ...
    notes: [
      { text: "Leader: curiosity satisfied", at: cue("beat-06", "curiosity") },
      { text: "Team: more work", at: cue("beat-06", "more") },
      { text: "Team: a delayed project", at: cue("beat-06", "delayed") },
    ],
  });
  ...
  assignVisual("beat-08", {
    ...
    title: "Separate the idea from the timing",
    left: "The idea",
    right: "The decision",
    rows: [
      {

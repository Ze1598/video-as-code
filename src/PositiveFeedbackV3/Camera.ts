...
// Ease-in-out, not the ease-out curve used for text entrances: a pan needs
// to accelerate away from its start AND decelerate into its next hold, or it
// reads as a snap with a decorative curve rather than a camera operator
// actually sweeping across the layout.
